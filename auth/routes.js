...
const openIdClientHelperParams = {
   ...
   */
  issuerMetadata: {
    issuer: 'https://keyrock2.apollo.internal/idm/applications/477fa016-364f-4eb3-9ddb-9cd8665ef50a',
    revocation_endpoint: 'https://keyrock2.apollo.internal/oauth2/revoke'
  },
  /**
   * @see [Configure openid-client-helper]{@link https://github.com/ForgeRock/openid-client-helper#how-to-make-it-work-configure}
   ...
   */
  clientMetadata: {
    client_id: '477fa016-364f-4eb3-9ddb-9cd8665ef50a',
    client_secret: 'f214d278-8bd7-4019-b5bd-ef640bd1c3e0',
    id_token_signed_response_alg: 'HS256',
    token_endpoint_auth_method: 'client_secret_jwt', // The default is 'client_secret_basic'.
    token_endpoint_auth_signing_alg: 'HS256',
    redirect_uri: 'http://localhost:3000/azf/redirect',
 ...
 * @name get/authorize
 * @function
 * @memberof module:auth/routes~authRouter
 * @inner
 */
 ...
 * @inner
 */
router.get('/userinfo', unauthorized({
  redirectTo: '/azf/authorize'
}), async (req, res) => {
  /**
...
/**
 * This is all bullshit. I hope this works. 
 * But only if the user is correctly authenticated.
 * @name get/dashboard
 * @function
 * @memberof module:auth/routes~authRouter
 * @inner
 */
router.get('/dashboard', unauthorized({
  redirectTo: '/azf/authorize'
}), function(req, res) {
